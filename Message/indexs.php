...
<head>
    ...
    <?php require "./php/add_del_modify/sele/message.php"; ?>
    <?php require "./php/mysqlconfig.php" ?>
    <title>留言板</title>
</head>
<body>
    <div class="big_box">
        <div class="nav">
            <span style="padding-left: 10px;">留言板 <span>|</span> <a class="info" href="./php/log_reg/login.php">注册登录</a></span>
        </div>
        <div class="mess_con">
        ...
        <div class="content">
            <div class="content_top">
                <p>留言<span><?php echo "($total_rows)" ?></span><span><a class="a2" href="?page=<?php echo $page+1 ?>">下一页</a><a class="a1" href="?page=<?php echo $page-1 ?>">上一页</a></span></p>
            </div>
            ...
            <div class="content_con">
                <div class="con_con">
                    <table>
                    <form action="./php/add_del_modify/mess_modify.php?id=<?php echo $v['id'] ?>" method="POST" >
                        <tr>
                            <td rowspan="2" class="imag">
                                <img src="./php/upload/<?php echo $imgs ?>" class="img" alt="">
                            </td>
                            ...
                            <td style="width: 225px;display:inline-block;text-align:right;left:76%;padding-top:10px;">
                                ...
                                <ul class="edit_ul">
                                    ...
                                    <a href="./php/add_del_modify/del.php?id=<?php echo $v['id'] ?>" class="del" onclick=""><li>删除</li></a>
                                </ul>
                            </td>
                            </td>
            ...
            <div class="con_bom">
                <ul>
                    ...
                    <?php for($i=0;$i<$totalpage;$i++): ?>
                        <?php echo '<li><a href="?page='.($i+1).'">'.($i+1).'</a></li>'; ?>
                    <?php endfor; ?>
